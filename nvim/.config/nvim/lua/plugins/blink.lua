...
-- The optional jsregexp build step (for regex support in snippets) runs from the
-- `PackChanged` hook in `lua/plugins/init.lua`.
local luasnip = require "luasnip"

-- Load friendly-snippets and our own vscode-style snippets.
